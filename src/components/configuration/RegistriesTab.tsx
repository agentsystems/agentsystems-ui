...
import styles from './RegistriesTab.module.css'
...
export default function RegistriesTab() {
  ...
  return (
    <div className={styles.registriesTab}>
      <div className={styles.header}>
        <div>
          <h2>Registry Connections</h2>
      ...
      <Card>
        <div className={styles.listHeader}>
          <h3>Configured Registries ({registries.length})</h3>
        </div>

        {registries.length === 0 ? (
          <div className={styles.emptyState}>
            <ServerIcon />
            <h4>No registries configured</h4>
